...
defmodule Taskscheduler.V1.RescheduleTaskRequest do
  ...
  field :task, 2, type: Task, oneof: 0
...
defmodule Taskscheduler.V1.TaskScheduler.Service do
  @moduledoc false

  use GRPC.Service, name: "taskscheduler.v1.TaskScheduler", protoc_gen_elixir_version: "0.11.0"
...
defmodule Taskscheduler.V1.TaskScheduler.Stub do
  @moduledoc false

  use GRPC.Stub, service: Taskscheduler.V1.TaskScheduler.Service
end